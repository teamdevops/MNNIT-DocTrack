...
<hr>
 ...
 <label>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
  <input type="text" class="myInput" name="name" value="<?php echo $name; ?>" required>
</label>
  &nbsp;&nbsp;Designation&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   :
<label>
  <input type="text"  class="myInput" name="designation" value="<?php echo $designation; ?>" placeholder="Designation" >
</label>
<br>
  <label>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Department   :
  <input type="text"  class="myInput" name="department" value="<?php echo $department; ?>" placeholder="department" required>
</label>
<label>
 &nbsp; Employee No. &nbsp;:
  <input type="text"  class="myInput" name="employeenumber" value="<?php echo $empid; ?>" placeholder="Employee No." required>
</label>
</form>
<br>
<p>
...
<p>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for the period from <input id="from_month" type="text"  class="myInput" size="10" name="month" placeholder="from"> to <input id="to_month" type="text"  class="myInput" size="10" name="month" placeholder="To"> as per details given below.<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The amount may be credited to my bank account number with Vijaya Bank <input type="text"  class="myInput" name="accnumber"  value="<?php echo $accno; ?>"  placeholder="A/C Number"><br>
	</p>
<form>
 <label>
...
<br>
  <label>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input type="text"  class="myInput" name="department" required>
</label>
<label>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MobileNo. :
  <input id ="mobile2" type="text"  class="myInput" name="mobileumber2" placeholder="postpaid." required>
</label>
</form>
...
<br/><br/>
<div align="center">
    <button class="noprint" type="button" onclick="confirmAlert();" >Confirm and Print</button>
